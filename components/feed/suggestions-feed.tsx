...
export function SuggestionsFeed({ onboardingData, onTripClick, savedTrips, onSavedTripClick }: SuggestionsFeedProps) {
            ...
            {savedTrips.length > 0 ? (
              ...
              <div className="flex-1 flex flex-col items-center justify-center py-16">
                ...
                <p className="text-muted-foreground text-center max-w-xs">
                  Start exploring and save trips you love to plan your next adventure.
                </p>
              </div>
            )}
          </div>
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="flex-1 px-8 md:px-16 lg:px-24 xl:px-32 overflow-y-auto py-1 pt-1 pb-10">
        <div className="max-w-[1400px] mx-auto">
          {/* Header */}
          <div className="mb-8">
